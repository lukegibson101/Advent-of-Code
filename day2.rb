...
def part_one(input)
  ...
  for i in 0..input.count-1
    if i.even?
      ...
      if player == "X" then score += 1 elsif player == "Y" then score += 2 else score += 3 end
      
      #score for outcome of the game
      # Loss = 0, Draw = 3, Win = 6
      if elf == "A"
        if player == "X" then score += 3 elsif player == "Y" then score += 6 else score += 0 end
      elsif elf == "B"
        if player == "X" then score += 0 elsif player == "Y" then score += 3 else score += 6 end
      elsif elf == "C"
        if player == "X" then score += 6 elsif player == "Y" then score += 0 else score += 3 end
      end
...
def part_two(input)
  ...
  puts "Part 2 Total Score: #{total_score}"
end
